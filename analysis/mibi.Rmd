...
```{r}
if ("mibi_ranger.RDS" %in% list.files("data")) {
  ranger.results <- readRDS("data/mibi_ranger.RDS")
} else {
  cv.folds = 10
  ...
  saveRDS(ranger.results, "data/mibi_ranger.RDS")
}
```
...
```{r}
if ("mibi_earth.RDS" %in% list.files("data")) {
  earth.results <- readRDS("data/mibi_earth.RDS")
} else {
  cv.folds = 10
  ...
  saveRDS(earth.results, "data/mibi_earth.RDS")
}
```
...
if ("mibi_lmbag.RDS" %in% list.files("data")) {
  lmbag.results <- readRDS("data/mibi_lmbag.RDS")
} else {
  cv.folds = 10
  ...
  saveRDS(lmbag.results, "data/mibi_lmbag.RDS")
}
```
